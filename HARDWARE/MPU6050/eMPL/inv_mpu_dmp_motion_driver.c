    ...
    unsigned long *timestamp, short *sensors, unsigned char *more)
{
    ...
    if (mpu_read_fifo_stream(dmp.packet_length, fifo_data, more))
		{
	//		printf("erro  at here:dmp_read_fifo 1283 !");
			//	USART1_Send_String("I'm at mpu_read_fifo_stream\n");
        return -1;
		}
    /* Parse DMP packet. */
    if (dmp.feature_mask & (DMP_FEATURE_LP_QUAT | DMP_FEATURE_6X_LP_QUAT)) {
        ...
        if ((quat_mag_sq < QUAT_MAG_SQ_MIN) ||
            ...
            mpu_reset_fifo();
            sensors[0] = 0;
//						USART1_Send_String("I'm at 1321\n");
							printf("erro  at here:dmp_read_fifo 1323 !");
            return -1;
